...
student = 'c08-timur-alejnikov',  # ваш_логин
pg_settings = {
    'host': 'rc1b-pkh0xycy94xo8dd1.mdb.yandexcloud.net',  # хост_вашего_postgresql
    'port': 6432,  # порт_вашего_postgresql
    'dbname': 'sprint9dwh',  # название_бд
    'username': 'de_user',  # имя_пользователя_для_подключения
    'password': 'de_password'  # пароль_для_подключения
}
...
path_s9_srv = '/home/tim/dev/YndDE/s9-lessons/sprint-9-sample-service'
